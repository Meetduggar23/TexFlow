...
function AboutPanel() {
  return (
    <div>
      <h2 className="text-xl font-semibold mb-1" style={{ color: 'var(--color-text-primary)' }}>About <span className="tf-brand"><span className="tf-brand-tex">Tex</span><span className="tf-brand-flow">Flow</span></span></h2>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <div className="text-lg font-bold tf-brand"><span className="tf-brand-tex">Tex</span><span className="tf-brand-flow">Flow</span></div>
