...
const definitions: Array<[string,string,ThemeType,ThemeTokens]> = [
  ...
  ['solarized-light','Solarized Light','light',light('#268BD2','#FDF6E3','#EEE8D5','#E6DFC9','#657B83','#EEE8D5')],
  ...
  ['light-high-contrast','Light High Contrast','high-contrast',light('#0000EE','#FFFFFF','#FFFFFF','#E5E5E5','#000000','#FFFF00')],
];
