      ...
      <div className="relative border border-texflow-800 rounded-2xl shadow-2xl w-full max-w-2xl mx-4" style={{ background: 'var(--color-background)' }}>
        ...
        <div className="p-4 space-y-4">
          <div className="flex gap-4">
            ...
            <div className="flex items-end"><label className="flex items-center gap-2 text-sm text-texflow-700"><input type="checkbox" checked={headerRow} onChange={e => setHeaderRow(e.target.checked)} className="accent-texflow-500" /> Header row</label></div>
          </div>
